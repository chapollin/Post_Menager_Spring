...
public class CidadeController {
	...
	public String cidadeForm(@ModelAttribute("cidade") 
						   Cidade cidade) {
		return "cidade_form";
	}
	
	@PostMapping("/cidades/new")
	public String cidadeNew(@Valid@ModelAttribute("cidade") 
							Cidade cidade,
							BindingResult br) {
		if(br.hasErrors()) {
			return "cidade_form";
	...
	public String cidadeUpdate(@PathVariable("id") 
	                         Integer id, 
	                         Model model) {
	...
	public String cidadeDelete(@PathVariable("id") 
							 Integer id) {
